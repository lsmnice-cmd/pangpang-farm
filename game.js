...
const SPRITES = {
    ...
    // 병아리 — 통통한 노란 아기새, 큰 검은 눈, 주황 부리·발 (20x20)
    chick: {
        p: { Y: '#FFDC3C', D: '#F0B400', O: '#FF8A00', K: '#222222', W: '#FFFFFF' },
        g: [
            '....................',
            '....................',
            '.........YYYY.......',
    ...
    // 닭 — 흰 몸 + 빨간 볏/턱볏, 노란 부리·다리, 풍성한 꼬리 (20x20)
    chicken: {
        p: { W: '#FAFAFA', S: '#CFCFCF', R: '#E23A3A', O: '#FFA800', K: '#222222' },
        g: [
            '....................',
            '............RR......',
            '...........RRRR.....',
    ...
    // 새끼 돼지 — 작고 동그란 분홍, 큰 코, 쫑긋 귀, 말린 꼬리 (20x20)
    piglet: {
        p: { P: '#FFB0C2', S: '#F58CA6', N: '#D85C7A', K: '#222222', W: '#FFFFFF' },
        g: [
            '....................',
            '....................',
            '......PP....PP......',
    ...
    // 돼지 — 크고 통통한 분홍 몸통, 큰 코, 귀, 네 다리, 말린 꼬리 (20x20)
    pig: {
        p: { P: '#F2A0B2', S: '#DB7B95', N: '#B0455F', K: '#222222', W: '#FFFFFF' },
        g: [
            '....................',
            '.....PP.............',
            '....PPPP............',
    ...
    // 송아지 — 갈색 몸 + 흰 점박이, 작은 뿔, 큰 눈 (20x20)
    calf: {
        p: { B: '#A06A40', S: '#E8C8B0', N: '#7A4A30', K: '#222222', W: '#FFF6EC', H: '#D8C0A0' },
        g: [
            '....................',
            '.......H............',
            '......HBH...........',
    ...
    // 소 — 큰 흰 몸 + 검은 점박이, 뿔, 분홍 코, 꼬리 (20x20)
    cow: {
        p: { W: '#F7F2EA', B: '#33291F', S: '#E8C8B0', N: '#E890A4', K: '#222222', H: '#D8D0C4' },
        g: [
            '....................',
            '.....H........H.....',
            '....HWH......HWH....',
