...
const SPRITES = {
    ...
    // 병아리 — 작고 동그란 노란 몸, 주황 부리/발 (옆모습)
    chick: {
        p: { Y: '#FFD93B', D: '#E6B800', O: '#FF8C00', K: '#3A2A00', W: '#FFFFFF' },
        g: [
            '................',
            '................',
            '.........YYY....',
    ...
    // 닭 — 흰 몸 + 빨간 볏/턱볏, 노란 부리·다리, 꼬리깃 (옆모습)
    chicken: {
        p: { W: '#F7F7F7', S: '#D0D0D0', R: '#E03B3B', O: '#FFB300', K: '#2A2A2A', T: '#C8C8C8' },
        g: [
            '................',
            '..........RR....',
            '.........RRRR...',
    ...
    // 새끼 돼지 — 작은 분홍 몸, 코·말린 꼬리 (옆모습)
    piglet: {
        p: { P: '#FFAFC0', S: '#F58BA4', N: '#D45C78', K: '#3A2030', W: '#FFFFFF' },
        g: [
            '................',
            '................',
            '......PP........',
    ...
    // 돼지 — 큰 분홍 몸통, 큰 코, 귀, 말린 꼬리 (옆모습)
    pig: {
        p: { P: '#F2A0B0', S: '#DB7B93', N: '#B0455F', K: '#3A2030', W: '#FFFFFF' },
        g: [
            '................',
            '.....PP.........',
            '....PPPPPPPPP...',
    ...
    // 송아지 — 갈색 작은 몸 + 흰 점박이, 작은 뿔 (옆모습)
    calf: {
        p: { B: '#A06A40', S: '#E8C8B0', N: '#7A4A30', K: '#2A1A0A', W: '#FFF6EC', G: '#D8C0A0', T: '#8A5A38' },
        g: [
            '................',
            '......G.........',
            '.....BGB........',
    ...
    // 소 — 큰 흰몸 + 검은 점박이, 뿔, 분홍 코, 꼬리 (옆모습)
    cow: {
        p: { W: '#F7F2EA', B: '#3A3026', S: '#E8C8B0', N: '#E08CA0', K: '#2A2018', G: '#D8D0C4', T: '#C8BEB0' },
        g: [
            '................',
            '....G.......T...',
            '...GWG.....TWT..',
